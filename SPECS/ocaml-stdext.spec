...
URL:            https://github.com/xapi-project/stdext/archive/stdext-%{version}.tar.gz
Source0:        https://github.com/xapi-project/stdext/archive/stdext-%{version}/%{name}-%{version}.tar.gz
