...
URL:            https://github.com/xapi-project/ocaml-xenstore-clients/archive/%{version}/%{name}-%{version}.tar.gz
Source0:        https://github.com/xapi-project/%{name}/archive/%{name}-%{version}/%{version}/%{name}-%{version}.tar.gz
