...
URL:            https://github.com/xen-org/xenopsd/archive/xenopsd-0.9.0.tar.gz
Source0:        xenopsd-0.9.0.tar.gz
...
BuildRequires:  ocaml-libvirt-devel libvirt ocaml-qmp-devel
...
DESTDIR=%{buildroot} ETCDIR=${_etcdir} SBINDIR=%{_sbindir} LIBEXECDIR=%{_libexecdir}/%{name} SCRIPTSDIR=%{_libexecdir}/%{name} scripts/make-custom-xenopsd.conf
...
install -m 0755 %{_sourcedir}/xenopsd-simulator %{buildroot}/%{_sysconfdir}/init.d/xenopsd-simulator
